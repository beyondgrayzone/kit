...
type ExtensionAPI interface {
	...
	GetHeaders() []ExtensionHeaderFooterConfig
	SetFooter(config ExtensionHeaderFooterConfig)
	RemoveFooter(id string)
	GetFooters() []ExtensionHeaderFooterConfig
...
func (e *extensionAPI) GetHeaders() []ExtensionHeaderFooterConfig {
	if e.kit.extRunner == nil {
		return nil
	}
...
func (e *extensionAPI) GetFooters() []ExtensionHeaderFooterConfig {
	if e.kit.extRunner == nil {
		return nil
	}
